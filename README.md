...
Features:
  ...
  - Easier updates. (You must provide the Flashpoint .7z file)
...
TODO:
  - Steamdeck support. (Need help don't have a Steamdeck also already might be supported just needs testing.)
